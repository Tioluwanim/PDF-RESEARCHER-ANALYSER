...
class IngestionJob(Base):
    ...
    logs = relationship("ProcessingLog", back_populates="ingestion_job", cascade="all, delete-orphan")
...
class ProcessingLog(Base):
    ...
    id = Column(Integer, primary_key=True)
    document_id = Column(Integer, ForeignKey("documents.id", ondelete="CASCADE"), nullable=True)
    ingestion_job_id = Column(Integer, ForeignKey("ingestion_jobs.id", ondelete="CASCADE"), nullable=True)
